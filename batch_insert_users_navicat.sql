-- 批量插入20个测试用户到 users 表（适配你的表结构）
INSERT INTO users (username, email, full_name, hashed_password, is_admin, is_active)
VALUES
('user01', 'user01@example.com', '测试用户01', '$2b$12$Qe0Qw6Qw6Qw6Qw6Qw6Qw6uQw6Qw6Qw6Qw6Qw6Qw6Qw6Qw6Qw6', 0, 1),
...
-- 导入后如有唯一索引冲突请先清空users表或调整用户名/邮箱